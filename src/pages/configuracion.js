...
export const Noticias = [
  ...
  { 
    titulo: "INTEL LANZA PROCESADORES CORE ULTRA 200V", 
    ...
    imagen: "logoSmall.png",
    texto: [
        "Intel ha anunciado su nueva línea de procesadores Core Ultra 200V, diseñados específicamente para portátiles de alta eficiencia. Con hasta 8 núcleos y 8 hilos, estos chips prometen duplicar la duración de la batería respecto a generaciones anteriores.",
        "La nueva arquitectura incluye una NPU dedicada que ofrece hasta 48 TOPS de rendimiento en tareas de IA, permitiendo nuevas experiencias como traducción en tiempo real y mejora automática de videollamadas."
    ],
    etiqueta: 2
  },
  { 
    titulo: "AMD DOMINA EL MERCADO CON RYZEN 9000", 
